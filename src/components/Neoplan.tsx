...
/** Базовая вертикальная матрица (2 + проход + 2) */
const layoutNeoplan: (number | null)[][] = [
  [1, 2, null, 3, 4],
  [5, 6, null, 7, 8],
  [9, 10, null, 11, 12],
  [13, 14, null, 15, 16],
...
const layoutHorizontal = transpose(layoutNeoplan);
...
export default function Neoplan({
  ...
  const seatButton = (seatNum: number) => {
    ...
    // ВАЖНО: выбранное перекрывает базовый статус
    const bg =
