  ...
  ru: [
    {
      ...
      text: [
        ...
        "Безопасность, надежность, ответственность и профессионализм — принципы, на которых строится наша работа уже 34 года!",
      ],
      bullets: [
  ...
  en: [
    {
      ...
      text: [
        ...
        "Safety, reliability, responsibility, and professionalism have guided our work for 34 years.",
      ],
      bullets: [
  ...
  bg: [
    {
      ...
      text: [
        ...
        "Безопасността, надеждността, отговорността и професионализмът са принципите, които ни водят 34 години.",
      ],
      bullets: [
  ...
  ua: [
    {
      ...
      text: [
        ...
        "Безпека, надійність, відповідальність і професіоналізм — принципи, на яких будується наша робота вже 34 роки!",
      ],
      bullets: [
