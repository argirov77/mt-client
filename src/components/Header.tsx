    ...
    <header className="bg-white/90 backdrop-blur supports-[backdrop-filter]:bg-white/70 sticky top-0 z-30 border-b border-slate-200">
      ...
      {isContactOpen ? (
        <div
          ...
          aria-modal="true"
        >
          <div className="w-full max-w-xl overflow-hidden rounded-[18px] border border-slate-200 bg-white shadow-2xl">
              ...
              <div className="flex flex-wrap gap-2" role="group" aria-label={t.message}>
                {(
                  ...
                  <button
                    ...
                    className={
                      method === item.key
                        ? "flex flex-1 items-center justify-center gap-2 rounded-[16px] border border-orange-200 bg-orange-50 px-3 py-2 text-xs font-black uppercase tracking-wide text-orange-700 shadow-md transition hover:-translate-y-0.5"
                        : "flex flex-1 items-center justify-center gap-2 rounded-[16px] border border-slate-200 bg-white px-3 py-2 text-xs font-black uppercase tracking-wide text-slate-700 transition hover:-translate-y-0.5 hover:shadow-md"
                    }
                  >
                    {item.key === "telegram" ? (
                ...
                {contacts.map((entry) => (
                  ...
                  >
                    ...
                    <a
                      ...
                      className="rounded-[14px] border border-slate-200 bg-slate-50 px-3 py-1 text-xs font-black uppercase tracking-wide text-slate-700 transition hover:-translate-y-0.5 hover:shadow-md"
                    >
                      {actionLabel[method]}
                    </a>
                  </div>
