  ...
  return (
    ...
    >
      <div className="relative flex items-center">
        <div className="relative">
          <input
            ...
            className="w-28 rounded-l-full rounded-r-none bg-slate-50/80 px-3 py-2.5 pr-8 text-base font-semibold text-slate-900 shadow-inner ring-1 ring-slate-200 focus:outline-none focus:ring-2 focus:ring-emerald-200"
      ...
      <input
        ...
        inputMode="numeric"
        maxLength={14}
        className="flex-1 min-w-[12ch] rounded-l-none rounded-r-full bg-slate-50/80 px-3 py-2.5 text-base text-slate-900 placeholder:text-slate-400 shadow-inner ring-1 ring-transparent focus:outline-none focus:ring-2 focus:ring-emerald-200"
      />
    </div>
  );
}
